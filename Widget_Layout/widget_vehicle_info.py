...
class Ui_Vehicle_Info(QtWidgets.QWidget):
    ...
    def setupUi(self):
        self.setObjectName("Vehicle Info")
        self.resize(540, 562)
        self.setWindowTitle("")
    ...
    def retranslateUi(self):
        ...
        self.setWindowTitle(_translate("Vehicle Info", "Vehicle Info"))
        self.qlabel_time.setText(_translate("Vehicle Info", ""))
        self.qlabel_brand.setText(_translate("Vehicle Info", ""))
        self.qlabel_plate.setText(_translate("Vehicle Info", ""))
        self.qlabel_image_owner.setText(_translate("Vehicle Info", ""))
        self.qlabel_web_api.setText(_translate("Vehicle Info", "THÔNG TIN ĐĂNG KIỂM"))
        self.qlabel_color.setText(_translate("Vehicle Info", ""))
        self.qlabel_speed.setText(_translate("Vehicle Info", ""))
        self.qlabel_cam_id.setText(_translate("Vehicle Info", "camera 01"))
        self.qlabel_plate_type.setText(_translate("Vehicle Info", ""))
